...
sap.ui.define(["sap/ui/core/mvc/Controller", 
	           ...
	           "cie/MTBF/model/formatter"
], function(Controller, UIComponent, History, formatter) {
	//---JS 严格模式
	"use strict";
	
	return Controller.extend("cie.MTBF.controller.BaseController", {
		...
		uniqueLocation: function(Arry){
		     let result = {};
		     let finalResult=[];
		     for(let i=0;i<Arry.length;i++){
		         result[Arry[i].FunctionalLocation]=Arry[i];
		     }
		     for(item in result){
